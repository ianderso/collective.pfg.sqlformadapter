...
def setup_product():
    ...
    import collective.pfg.sqlformadapter
    zcml.load_config('configure.zcml', collective.pfg.sqlformadapter)
    ...
    ztc.installPackage('collective.pfg.sqlformadapter')
...
setup_product()
ptc.setupPloneSite(products=['collective.pfg.sqlformadapter'])
